...
const NonnasTableCaseStudy = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-sm border-b border-brand-charcoal-gray">
      ...
      {/* Challenge Section */}
      <section className="py-20 bg-brand-charcoal-gray">
        <div className="container mx-auto px-6">
                ...
                <ul className="space-y-3 mb-6">
                  {caseStudy.key_features.map((feature, index) => (
                    <li key={index} className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-brand-neon-pink rounded-full flex-shrink-0 mt-3"></div>
                      <span>{feature}</span>
                    </li>
                  ))}
                </ul>
            ...
            {solutionMedia.length > 0 && (
              <div className="grid md:grid-cols-2 gap-8 mb-16">
                {solutionMedia.map((mediaItem) => (
                  <div key={mediaItem.id} className="bg-brand-charcoal-gray rounded-lg p-6">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-brand-neon-pink rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <button
              ...
              className="brand-button-primary inline-flex items-center gap-2 px-8 py-4 rounded-full font-semibold text-lg font-space-grotesk"
            >
