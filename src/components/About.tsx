      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-3xl mx-auto mt-12">
          <div>
            ...
            <p className="text-white/80 leading-relaxed mb-8 text-center text-lg sm:text-xl font-light">At HumbleStudio.ai, I combine that eye for quality with daily knowledge of AI tools. I use automation to move fast — and bring in humans when it matters.</p>
