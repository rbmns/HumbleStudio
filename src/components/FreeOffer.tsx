    ...
    <section className="py-16">
      <div className="container mx-auto px-4 md:px-6">
        <div className="relative bg-humble-gray-800/50 rounded-2xl overflow-hidden p-8 md:p-12">
          <div className="absolute inset-0 bg-gradient-to-br from-purple-600/20 to-humble-pink-400/20 backdrop-blur-sm"></div>
          
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            <span className="inline-block bg-gradient-to-r from-purple-500 to-humble-pink-500 text-white px-4 py-1 rounded-full text-sm font-medium mb-6">Limited Time Offer</span>
            ...
            <a 
              ...
              className="px-8 py-3 rounded-full bg-gradient-to-r from-purple-500 to-humble-pink-500 text-white font-medium text-lg hover:scale-105 transition-all duration-300 inline-flex items-center justify-center"
            >
              Claim Your Spot
            </a>
          </div>
