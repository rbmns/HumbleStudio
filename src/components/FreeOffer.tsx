    ...
    <section className="py-16">
      <div className="container mx-auto px-4 md:px-6">
        <div className="relative bg-humble-gray-800/50 rounded-2xl overflow-hidden p-8 md:p-12">
          <div className="absolute inset-0 bg-gradient-to-br from-humble-purple-600/20 to-humble-purple-400/20 backdrop-blur-sm"></div>
          
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            <span className="inline-block bg-gradient-to-r from-humble-purple-500 to-humble-purple-400 text-white px-4 py-1 rounded-full text-sm font-medium mb-6">Limited Time Offer</span>
            ...
            <div className="grid gap-6 sm:grid-cols-3 text-center mb-8">
              ...
              <div className="bg-humble-gray-900/50 rounded-lg p-4">
                <div className="text-3xl font-bold text-humble-purple-400 mb-2">24hr</div>
            ...
            <a 
              ...
              className="px-8 py-3 rounded-full bg-gradient-to-r from-humble-purple-500 to-humble-purple-400 text-white font-medium text-lg hover:scale-105 transition-all duration-300 inline-flex items-center justify-center"
            >
              Claim Your Spot
            </a>
          </div>
