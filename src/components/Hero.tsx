  ...
  return (
    <div ref={heroRef} className="relative min-h-screen flex items-center justify-center px-6 sm:px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Gradients overlay */}
        <div className="absolute inset-0 bg-gradient-radial from-purple-600/20 to-transparent opacity-30"></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto text-center z-10">
        ...
        <div className="w-full max-w-lg mx-auto h-[2px] bg-gradient-to-r from-purple-500 to-humble-pink-500 mb-8 opacity-70"></div>
        ...
        <div className="flex flex-col sm:flex-row sm:gap-4 justify-center mt-8">
          <a
            href="https://form.typeform.com/to/iwNqCI7O"
            target="_blank"
            rel="noopener noreferrer"
            className="max-w-[220px] w-full mx-auto sm:w-auto px-6 py-2.5 sm:py-3 rounded-full bg-gradient-to-r from-purple-500 to-humble-pink-500 text-white font-medium text-lg flex items-center justify-center gap-2 hover:scale-105 transition-all duration-300 shadow-lg shadow-purple-500/20"
          >
            Book a Free Site
            <ArrowRight size={18} />
          </a>
          <button 
            ...
            className="max-w-[220px] w-full mx-auto sm:w-auto px-6 py-2.5 sm:py-3 rounded-full bg-white/10 hover:bg-white/20 text-white font-medium text-lg transition-all duration-300 backdrop-blur-sm"
          >
            How It Works
          </button>
        </div>
