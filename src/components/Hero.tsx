    ...
    <div ref={heroRef} className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <SparklesCore
          ...
          particleColor="#8BE1FB"
          speed={1}
        />
        
        {/* Gradients overlay */}
        <div className="absolute inset-0 bg-gradient-radial from-humble-blue-600/20 to-transparent opacity-30"></div>
      </div>
      
      <div className="max-w-4xl mx-auto text-center z-10 mt-16">
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight tracking-tight">
          <span className="text-white">Humble</span>
          <span className="bg-gradient-to-r from-humble-blue-400 to-humble-green-500 bg-clip-text text-transparent">Studio</span>
        </h1>
        
        <div className="w-full max-w-lg mx-auto h-[2px] bg-gradient-to-r from-humble-blue-500 to-humble-green-500 mb-8 opacity-70"></div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
          <a
            ...
            className="px-8 py-3 rounded-full bg-gradient-to-r from-humble-blue-500 to-humble-green-500 text-white font-medium text-lg flex items-center justify-center gap-2 hover:scale-105 transition-all duration-300"
          >
            Book a Free Site
            <ArrowRight size={18} />
          </a>
