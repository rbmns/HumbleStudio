      ...
      <div className="max-w-4xl mx-auto text-center z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
          <a
            ...
            className="px-8 py-3 rounded-full bg-gradient-to-r from-humble-blue-500 to-humble-green-500 text-white font-medium text-lg flex items-center justify-center gap-2 hover:scale-105 transition-all duration-300 shadow-lg shadow-humble-blue-500/20"
          >
            Book a Free Site
            <ArrowRight size={18} />
          </a>
