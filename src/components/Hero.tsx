      ...
      <div className="max-w-4xl mx-auto text-center z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-2 justify-center mt-8">
          <a
            ...
            className="max-w-[220px] w-full mx-auto sm:w-auto px-6 py-3 rounded-full bg-gradient-to-r from-purple-500 to-humble-pink-500 text-white font-medium text-lg flex items-center justify-center gap-2 hover:scale-105 transition-all duration-300 shadow-lg shadow-purple-500/20"
          >
            Book a Free Site
            <ArrowRight size={18} />
          </a>
          <button 
            ...
            className="max-w-[220px] w-full mx-auto sm:w-auto px-6 py-3 rounded-full bg-white/10 hover:bg-white/20 text-white font-medium text-lg transition-all duration-300 backdrop-blur-sm"
          >
            How It Works
          </button>
        </div>
