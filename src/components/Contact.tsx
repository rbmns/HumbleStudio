      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mt-12 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-humble-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-humble-gray-700/50 hover:border-humble-blue-400/50 transition-all duration-300">
              <a href="https://linkedin.com/company/humblestudio-ai" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-white/80 hover:text-white transition-colors">
                <div className="w-12 h-12 rounded-full bg-humble-gray-800 flex items-center justify-center">
                  <Linkedin size={20} className="text-humble-blue-400" />
                </div>
                <div>
